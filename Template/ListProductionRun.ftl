 <div class="screenlet">
   <div class="screenlet-title-bar">
      <h3>${uiLabelMap.DemoOfbizResult}</h3>
    </div>
                ...
                <thead><tr>
                  ...
                  <tbody>
                      <#list productionRunList as productionRun>
                          <tr>
                               <td>
                                     <a href="<@ofbizUrl>UpdateProductionRunDemo?productionRunId=${productionRun.workEffortId!}</@ofbizUrl>" target="_blank">${productionRun.workEffortId!}</a>
                               </td>
